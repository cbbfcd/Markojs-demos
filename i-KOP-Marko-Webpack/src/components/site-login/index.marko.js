...
var marko_template = module.exports = require("marko/dist/html").t(__filename),
    ...
    marko_componentType = marko_registerComponent("/xz-oidc$1.0.0/src/components/site-login/index.marko", function() {
    ...
    login_page_template = marko_loadTemplate(require.resolve("./components/login-page")),
...
function render(input, out, __component, component, state) {
  ...
  login_page_tag({}, out, __component, "1");
